...
screw_size =2.58; // [M3:3.08, M2.5:2.58]
...
module doortext() {
		translate([18,1,13]) rotate([90,0,0]) {
		//	linear_extrude(2.4) text(logo_top, size=5, font="Liberation Sans:style=Bold");
		linear_extrude(1.5) text(logo_top, size=5, font="Liberation Sans:style=Bold");
		}
		translate([18,1,8]) rotate([90,0,0]) {
			//linear_extrude(2.2) text(logo_bottom, size=3,font="Liberation Sans:style=Bold");
			linear_extrude(1.5) text(logo_bottom, size=3,font="Liberation Sans:style=Bold");
		}
}
module door() {
	difference() {
...
if(part == "everything" || part == "lid_light_gray_text") translate([2,120,20.5]) rotate([180,0,0]) doortext();
if( part == "lid_light_gray_All") translate([2,120,20.5]) rotate([180,0,0]) {color([.70,.50,.40])door();color([.40,.50,.7])doortext(); }
