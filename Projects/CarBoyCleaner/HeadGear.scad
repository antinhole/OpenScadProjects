...
pressure_angle=28;
AngleFactor=1.5;
bearing_outside =22.25;//22.21
bearing_outside_lip =19.7;

difference(){
		union(){haringBoneGear(
			...
			hole_diameter   = 60,    //2.25" =57.15mm standard 6.5 carboy  diameter of the hole in the center, in mm
		...
		cylinder(d=87, h=thickness, center=true);
		}
		//////////////////////////////////
			cylinder(d=57, h=thickness, center=true);
		spoke_ify(25){
		translate([25, 15, 0])
